...
@section('content')
    ...
    {{--<form action="{{ route('hamshs.forms.update',$form->id) }}" method="POST">--}}
        @csrf
{{--        @method('PUT')--}}
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" value="{{ $form->ArticalTitle }}" class="form-control"
                                   placeholder="Title">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" style="height:150px" name="description"
                                      placeholder="Description">{{ $form->PublishDate }}</textarea>
                        </div>
                    </div>
